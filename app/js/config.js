...
async function salvarEmpresaSupabase(dados) {
    ...
    try {
        ...
        console.error('[Empresa] Erro ao salvar no Supabase:', e);
        return false;
    }
}

async function carregarEmpresaSupabase() {
    if (!currentUser || !supabaseClient) return null;
    try {
        ...
        console.error('[Empresa] Erro ao carregar do Supabase:', e);
        return null;
    }
}

window.comprimirImagem = comprimirImagem;
window.salvarEmpresaSupabase = salvarEmpresaSupabase;
window.carregarEmpresaSupabase = carregarEmpresaSupabase;
